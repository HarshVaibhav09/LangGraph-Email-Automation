...
class GmailToolsClass:
    ...
    def send_email(self, recipient, subject, body_text):
        """
        Send a standalone email (not a reply) to a recipient.
        
        @param recipient: Email address of the recipient
        @param subject: Subject line of the email
        @param body_text: Body content of the email
        @return: Sent message object or None if error
        """
        try:
    ...
    def _create_html_email_message(self, recipient, subject, reply_text, is_reply=False):
        """
        Creates a simple HTML email message with proper formatting and plaintext fallback.
        
        @param recipient: Email address of the recipient
        @param subject: Subject line of the email
        @param reply_text: Body content of the email
        @param is_reply: Whether this is a reply (adds "Re: " prefix if not present)
        """
