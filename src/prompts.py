...
2. Use the following rules to assign the correct category:
   - **product_enquiry**: When the email seeks information about a product feature, benefit, service, pricing, or asks questions about the company's offerings. This includes ANY question about services, features, or business-related inquiries.
   - **customer_complaint**: When the email communicates dissatisfaction, a complaint, or expresses problems with service/product.
   - **customer_feedback**: When the email provides feedback, suggestions, compliments, or opinions regarding a product or service.
   - **unrelated**: ONLY use this category for emails that are clearly spam, automated notifications, newsletters, or completely unrelated commercial messages. When in doubt, categorize as product_enquiry or customer_feedback instead.
...
* Be lenient in categorization - when uncertain, prefer product_enquiry or customer_feedback over unrelated.
* Only mark as "unrelated" if the email is clearly spam, automated, or has no business relevance whatsoever.
* Most customer emails should be categorized as one of the first three categories.
"""
